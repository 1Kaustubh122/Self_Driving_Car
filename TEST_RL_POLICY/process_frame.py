...
# YOLO_MODEL_PATH = 'models/yolo11s.pt'  # Note: Use 'yolo11s-seg.pt' if segmentation is needed
...
#             else:
#                 print("⚠️ No masks found, but objects detected")
#         else:
#             print("⚠️ No objects detected in the frame")
